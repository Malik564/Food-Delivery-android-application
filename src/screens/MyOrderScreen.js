            ...
            data = {Data}
             ...
             renderItem = {({ item , index}) => (
                <View key={item.id}>
                 ...
                 <Text style ={{fontSize:16,color:'#000',  }}>name: {RestaurantData[index]?.restaurantName} </Text>
                  <Text style ={{fontSize:13,color:'#000',  }}>{RestaurantData[index]?.restaurantContact }</Text>
                  <Text style ={{fontSize:13,color:'#000',  }}>{RestaurantData[index]?.businessAddress}</Text>
